...
**Customer:** ESMINCUBYTE (fictional org in this assessment)
...
| Left out | Reason |
|---|---|
| Payroll runs, tax, statutory deductions, payslips | Different product. ESMINCUBYTE asked to manage salary data and understand pay, not to become a payroll engine. |
...
| Gender or other unnecessary sensitive demographics | Easy to get ethically and legally wrong; not required to answer how ESMINCUBYTE pays. |
